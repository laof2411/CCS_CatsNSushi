...
namespace VrGamesDev.Editor
{
    ...
    public class VRG_Editor_CORE : VRG_Editor
    {
        ...
        [MenuItem("Tools/Vr Games Dev/Examples/CORE/Clear Build Settings from examples", false, 99902)]
        public static void Example_99921()
        {
        ...
        [MenuItem("Tools/Vr Games Dev/CORE/Utils//VRG_OpenUrl", false, 4002)]
        public static void VRG_OpenUrl() => CreatePrefab(m_Prefabs + "Utils/VRG_OpenUrl");

        [MenuItem("Tools/Vr Games Dev/CORE/Utils/VRG_FPS: Frames Per Second", false, 4003)]
